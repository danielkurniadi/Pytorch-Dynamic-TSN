...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--split_idx', type=int, required=True, help='Split index, also known as "k" in KFold technique')
        ...
        parser.add_argument('--epochs', type=int, default=15, help='# of epochs in one training session')
